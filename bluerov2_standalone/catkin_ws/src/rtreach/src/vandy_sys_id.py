...
class genSysIDData:
    ...
    def __init__(self,path):
        ...
        self.odometry_sub=rospy.Subscriber("pose_gt_ned", Odometry,self.odom_callback,queue_size = 20)
        self.hsd =rospy.Subscriber("delta_hsd",HSDCommand,self.master_callback,queue_size = 20)
