...
class genSysIDData:
    ...
    def __init__(self,path):
        ...
        self.odometry_sub=rospy.Subscriber("pose_gt", Odometry,self.odom_callback,queue_size = 20)
        self.hsd =rospy.Subscriber("hsd_command",HSDCommand,self.master_callback,queue_size = 20)
