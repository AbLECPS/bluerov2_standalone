...
class ThrusterFunction(object):
    def __init__(self):
        ...
        self.thruster_0_pub = rospy.Publisher(
            'thrusters/0' + self.topic_suffix_default, FloatStamped, queue_size=1)
        self.thruster_1_pub = rospy.Publisher(
            'thrusters/1' + self.topic_suffix_default, FloatStamped, queue_size=1)
        self.thruster_2_pub = rospy.Publisher(
            'thrusters/2' + self.topic_suffix_default, FloatStamped, queue_size=1)
        self.thruster_3_pub = rospy.Publisher(
            'thrusters/3' + self.topic_suffix_default, FloatStamped, queue_size=1)
        self.thruster_4_pub = rospy.Publisher(
            'thrusters/4' + self.topic_suffix_default, FloatStamped, queue_size=1)
        self.thruster_5_pub = rospy.Publisher(
            'thrusters/5' + self.topic_suffix_default, FloatStamped, queue_size=1)
    ...
    def get_thruster_config(self):
        try:
            rospy.wait_for_service('thruster_manager/get_config', timeout=5)
    ...
    def set_thruster_topic_suffix(self, thruster_config, thruster_topic_suffix):
        ...
        try:
            rospy.wait_for_service('thruster_manager/set_config', timeout=5)
        except rospy.ROSException:
        ...
        # reset DP Controller
        try:
            rospy.wait_for_service('reset_controller', timeout=5)
        except rospy.ROSException:
    ...
    def get_TAM(self):
        try:
            rospy.wait_for_service('thruster_manager/get_thrusters_info', timeout=5)
        except rospy.ROSException:
    ...
    def hold_vehicle(self):
        try:
            rospy.wait_for_service('hold_vehicle', timeout=5)
        except rospy.ROSException:
