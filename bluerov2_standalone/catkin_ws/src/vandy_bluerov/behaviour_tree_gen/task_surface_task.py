...
class TaskHandler(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, 
        ...
        self.hsd_to_surface__sub = rospy.Subscriber( 'hsd_to_surface',
                                            HSDCommand,
...
############<<USER SETUP CODE ENDS>>################################
    ...
    def hsd_to_surface__callback(self, msg):
        self.hsd_to_surface__msg = msg
############<<USER SUB_hsd_to_surface_ CODE BEGINS>>##############################
############<<USER SUB_hsd_to_surface_ CODE ENDS>>################################        
...
############<<USER UPDATE CODE BEGINS>>##############################
        ...
        self.blackboard.HSD_out.heading = self.hsd_to_surface__msg.heading
        self.blackboard.HSD_out.depth = self.hsd_to_surface__msg.depth
