...
############<<USER CUSTOM CODE BEGINS>>##############################
    ...
    def process_mission(self, mission_data):
        ...
        if mission_data.get('termination_conditions') is not None:        
            ...
            print("No 'termination_conditions' defined in mission file.")
        
        if mission_data.get('assurance_technologies') is not None:
            ...
            print("No 'assurance_technologies' defined in mission file.")
