...
import bb_ddlec2bb  
import bb_rtreach_index2bb  
import bb_rtreach2bb  
import bb_rtreach_unsafe_value2bb  
...
class BlueROV_BT(object):
    def __init__(self):            
        ...
        self.speed_good_log_val = rospy.get_param('~speed_good_log_val', 10.0)   
    ...
    def create_root(self):
        ...
        rtreach_index2bb = bb_rtreach_index2bb.ToBlackboard(
            name="rtreach_index2bb",
            topic_name="/unsafe_hyperrectangle_index" 
        )
        ...
        rtreach_unsafe_value2bb = bb_rtreach_unsafe_value2bb.ToBlackboard(
            name="rtreach_unsafe_value2bb",
            topic_name="/unsafe_grid_value" 
        )
        ...
        dd_xy_axis = py_trees.blackboard.CheckBlackboardVariable(
            ...
            variable_name='dd_xy_axis_degradation',
            expected_value= False)
        rtreach_check = py_trees.blackboard.CheckBlackboardVariable(
            name="rtreach_check",
            variable_name='rtreach_warning',
            expected_value= False)
        rtreach_fence_check = py_trees.blackboard.CheckBlackboardVariable(
            name="rtreach_fence_check",
            variable_name='rtreach_fence_warning',
            expected_value= False)
        rtreach_obstacle_check = py_trees.blackboard.CheckBlackboardVariable(
            name="rtreach_obstacle_check",
            variable_name='rtreach_obstacle_warning',
            expected_value= False)
        rtreach_long_term_check = py_trees.blackboard.CheckBlackboardVariable(
            name="rtreach_long_term_check",
            variable_name='rtreach_long_term_warning',
            expected_value= False)
