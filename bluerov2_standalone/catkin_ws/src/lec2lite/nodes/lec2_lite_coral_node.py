...
class LEC2Lite(object):
    def __init__(self):
        ...
        rp = rospkg.RosPack()
        tflite_filename = os.environ["ALC_WORKING_DIR"] + "/jupyter/admin_BlueROV/LEC2Lite/" + rospy.get_param('~filename', 'lec2_quant_edgetpu.tflite')
        ...
        self.interpreter = edgetpu.make_interpreter(tflite_filename)
